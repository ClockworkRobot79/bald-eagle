    ...
    const facts = [
        ...
        },
        {
            ...
            text: [
                ...
                "The largest bald eagle nest is 9.5 ft wide and 20 ft high.",
            ],
        },
        {
            img: "nest2",
            text: [
                "A bald eagle nest can weigh up to 100,000 pounds.",
                "A bald eagle nest can weigh up to 4,000 pounds.",
            ],
        },
        {
            img: "old",
            text: [
                "They can live up to 8 years in the wild, 62 years in captivity.",
                "They can live up to 28 years in the wild, 36 years in captivity.",
            ],
        },
        {
            img: "carry",
            text: [
                "A mature bald eagle can lift 40-50 pounds.",
        ...
        },
        {
            img: "hospital",
            text: [
                "The bald eagle got its name because the feathers on its head fall out after 5 years.",
